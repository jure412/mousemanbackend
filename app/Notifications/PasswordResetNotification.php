...
class PasswordResetNotification extends Notification
{
    ...
    {
        $urlToResetForm = 'http://localhost:3000/changepassword/'.$this->token.'&'.$notifiable->getEmailForPasswordReset();
        return (new MailMessage)
        ->subject(Lang::getFromJson('hello Reset Password Notification'))
